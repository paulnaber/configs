...
prompt_and_copy "$HOME/Library/Application Support/Code/User/settings.json" "$HOME/Documents/Projects/personal/configs/vscode"
prompt_and_copy "$HOME/Library/Application Support/Code/User/keybindings.json" "$HOME/Documents/Projects/personal/configs/vscode"
prompt_and_copy "$HOME/.ideavimrc" "$HOME/Documents/Projects/personal/configs/.ideavimrc"
prompt_and_copy "$HOME/Downloads/vimium-options.json" "$HOME/Documents/Projects/personal/personal/configs/vimium-options.json"
prompt_and_copy "$HOME/.zshrc" "$HOME/Documents/Projects/personal/configs/terminal"
prompt_and_copy "$HOME/Desktop/Profiles.json" "$HOME/Documents/Projects/personal/configs/terminal/iTerm2/"
